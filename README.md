...
```
{
   ...
   "Stage":{
      ...
      "message":{
         "q18":"총 세일 기간동안 몇 개의 스테이지로 나눠서 진행하나요?",
         "q18_1":"n번째 스테이지의 시작 시간은 언제인가요?",
         "q18_2":"n번째 스테이지의 종료 시간은 언제인가요?",
   ...
   "PeriodBonusStage":{
      ...
      "message":{
         "q23":"n번째 스테이지에 몇 개의 기간별 보너스 구간이 있나요?",
         "q23_1":"n번째 스테이지에 y번째 보너스 구간의 종료 시간을 적어주세요.",
         "q23_2":"n번째 스테이지에 y번째 보너스 구간의 보너스 퍼센트를 적어주세요.",
         "_comment":{
            "q23":"x결정",
            "q23_1":"x번 반복",
            "q23_2":"x번 반복"
   ...
   "AmountBonusStage":{
      ...
      "message":{
         ...
         "q24_2":"k번째 구매 수량 보너스의 수량을 적어주세요(큰 보너스 --> 작은 보너스 순, 큰 보너스 부터)",
         "q24_3":"k번째 구매 수량 보너스의 퍼센트를 적어주세요(큰 보너스 --> 작은 보너스 순, 큰 보너스 부터)",
         "_comment":{
            "q24_2":"z번 반복",
            "q24_3":"z번 반복"
         }
   ...
   "Multisig":{
      ...
      "message":{
         "25":"멀티시그니처 기능을 사용하나요?",
         "25_1":"몇개의 멀티시그 지갑을 쓸 건가요?",
         "25_2":"n번째 멀티시그 지갑의 오너 계정은 몇개인가요?",
         "25_3":"오너 계정 중 몇개의 계정이 동의해야 출금 가능한가요?",
         "25_4":"n번째 멀티시그 지갑의 y번째 오너 계정을 적어주세요(이더리움 계정)",
         "_comment":{
            "q25_1":"m결정",
            "q25_4":"x번 반복"
         }
   ...
   "Locker":{
      ...
      "message":{
         ...
         "26_1":"몇 개의 락커가 필요한가요?",
         "26_2":"m개의 락커 중 n번째 락커의 토큰을 받을 계정은 몇개인가요?",
         "26_3":"x개의 계정 중 y번째 계정은 <멀티시그> 인가요 <EOA>인가요?",
         "26_3_1":"(멀티시그라면) n번째 락커에서 받을 멀티시그 지갑을 선택해주세요",
         "26_3_2":"(EOA라면) n번째 락커에서 받을 EOA 어카운트를 적어주세요",
         "26_4":"n번 락커의 y번째 계정은 락커가 보유한 토큰의 몇 퍼센트를 가져가나요?",
         "26_5":"n번 락커의 y번째 계정의 릴리즈 타입은?(#1 : 계단형, #2 : 선형)",
         "26_6":"n번 락커의 y번째 계정은 몇 번의 기간에 걸쳐 릴리즈를 하나요?",
         "26_6_1":"n번 락커의 y번째 계정의 i번째 구간의 릴리즈 종료 시간을 설정해주세요",
         "26_6_2":"n번 락커의 y번째 계정의 i번째 구간의 릴리즈 비율을 설정해 주세요",
         "_comment":{
            "q26_1":"m결정",
            "q26_2":"m번 반복, x결정",
            "q26_3":"x번 반복",
            "q26_3_1":"x번 반복(아래항과 합쳐서)",
            "q26_3_2":"x번 반복(위항과 합쳐서)",
            "26_6":"i결정",
            "q26_6_1":"i번 반복",
            "q26_6_2":"i번 반복, 총합은 100%"
         }
      }
   },
   "TokenDistribution":{
      ...
      "message":{
         "q27":"크라우드세일을 통해 판매되는 토큰은 몇 퍼센트 인가요?",
         "q28":"크라우드 세일 이외에 토큰이 분배되는 계정의 갯수는 몇개인가요?",
         "q28_1":"m개 중 n번째 계정의 종류는 무엇인가요?(락커, EOA)",
         "q28_2":"(n번째 계정이 EOA일 경우)주소를 입력 해 주세요",
         "q28_3":"m개 중 n번째 계정이 전체 토큰 발행량 중 가져가는 비율은?",
         "_comment":{
            "q28":"m결정"
         }
      }
   ...
   "EtherDistribution":{
      ...
      "message":{
         "q29":"몇 개의 주소에 이더를 보관하나요?",
         "q29_1":"m개의 주소 중 n번째 계정의 종류는?(1.EOA 2.멀티시그)",
         "q29_1_1":"(EOA라면)m개 중 n번째의 주소(address)를 적어주세요",
         "q29_1_2":"(멀티시그라면)m개 중 n번째의 멀티시그 월렛 번호(앞에서 만든)를 적어주세요",
         "q30":"m개의 주소 중 n번째 주소의 할당량을 적어주세요",
         "_comment":{
            "q29":"m결정",
            "q29_1":"m번 반복",
            "q29_1_1":"(아래것과 합쳐서) m번 반복",
            "q29_1_2":"(위의것과 합쳐서) m번 반복",
            "q30":"m번 반복"
         }
      }
   }
